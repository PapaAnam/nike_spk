        ...
        <nav class="navbar navbar-expand-md navbar-light navbar-laravel">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    <img src="{{ asset('images/logo.jpeg') }}" width="30" height="30" class="d-inline-block align-top" alt="">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item {{ isset($active) ? ($active == 'gaji-saya' ? 'active' : '') : '' }}">
                            <a class="nav-link" href="{{ route('gaji-saya') }}">Gaji Saya</a>
                        </li>
                        @endif
                        @endauth
                    </ul>
                        ...
                        <li class="nav-item">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    @if(Auth::user()->role === 'admin')
                                    <a class="dropdown-item" href="{{ route('ubah-username') }}">
                                        Ubah Username
                                    </a>
                                    @endif
